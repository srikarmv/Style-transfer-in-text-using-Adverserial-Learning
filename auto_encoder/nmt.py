...
def train(dim_word=100,  # word vector dimensionality
    ...
    f_log_probs = theano.function(inps1, cost, profile=profile)
    print 'Done'
    ...
    f_cost = theano.function(inps1, cost, profile=profile)
    print 'Done'
    ...
    for eidx in xrange(max_epochs):
        ...
        for x, y, senti in train:
            ...
            if numpy.mod(uidx, dispFreq) == 0:
                print 'Epoch ', eidx, 'Update ', uidx, 'Cost ', cost, cost_d, cost_h, 'UD ', ud
