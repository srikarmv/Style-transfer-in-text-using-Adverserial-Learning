...
def gru_cond_simple_layer(tparams, state_below, options, prefix='gru',
    ...
    # projected context to hidden state 
...
def train(dim_word=100,  # word vector dimensionality
          ...
          datasets=[
              '/data/europarl/europarl-v7.fr-en.en.tok',
              '/data/europarl/europarl-v7.fr-en.fr.tok'],
          valid_datasets=['../data/dev/newstest2011.en.tok',
                          '../data/dev/newstest2011.fr.tok'],
          dictionaries=[
              '/data/europarl/europarl-v7.fr-en.en.tok.pkl',
              '/data/europarl/europarl-v7.fr-en.fr.tok.pkl'],
          use_dropout=False,
          reload_=False,
          overwrite=False,
          senti_num=2,
